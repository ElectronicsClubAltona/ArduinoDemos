/*
 * September 9th 2015  Mike
 * picks up the server address on line 33 and displays via serial
 * HanRun Ethernet connector 
 * Same unit runs the SD card demo well too
 * 
  Web Server
...
worked OK - need to setup a MAC address and IP address
...
void setup() {
  ...
  Serial.println(Ethernet.localIP());   // mostly returns 0.0.0.0  
}
